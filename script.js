...
window.addEventListener('load', () => {
    ...
    // Log welcome message
    console.log('%c🚀 VisionX Telecom - Connecting Canada!', 'font-size: 20px; color: #0066cc; font-weight: bold;');
...
if (footerBottom) {
    footerBottom.textContent = `© ${currentYear} VisionX Telecom. All rights reserved.`;
}
